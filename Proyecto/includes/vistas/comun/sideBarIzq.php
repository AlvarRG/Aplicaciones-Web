...
<nav id="sidebarIzq">
    ...
    <?php if ($esPersonal): //Si el usuario forma parte del personal muestra la gestión de pedidos y las tablets, distinguiendo su rol concreto?>
        ...
        <ul>
            <li><a href="<?= $rutaApp ?>/gestion_pedidos.php">Pedidos (Global)</a></li>
            
            <?php if ($esCamarero || $esAdmin): ?>
                <li><a href="<?= $rutaApp ?>/tablet_camarero.php">Tablet Camarero</a></li>
            <?php endif; ?>

            <?php if ($esCocinero || $esAdmin): ?>
                <li><a href="<?= $rutaApp ?>/tablet_cocina.php">Tablet Cocina</a></li>
            <?php endif; ?>
        </ul>
    <?php endif; ?>
