...
INSERT INTO `pedidos` (`id`, `id_usuario`, `numero_pedido`, `fecha`, `estado`, `tipo`, `total`, `id_cocinero`) VALUES
(1, 1, 1, '2026-02-25 10:42:27', 'Entregado', 'Local', 15.00, NULL),
(2, 1, 2, '2026-02-25 10:43:56', 'Entregado', 'Local', 7.50, NULL),
(3, 1, 3, '2026-02-25 10:44:29', 'Entregado', 'Llevar', 15.00, NULL),
(4, 1, 4, '2026-02-25 11:11:32', 'Entregado', 'Local', 7.50, NULL),
(5, 2, 5, '2026-02-25 11:17:07', 'Cancelado', 'Llevar', 7.50, NULL),
(6, 1, 6, '2026-02-25 12:05:53', 'Entregado', 'Local', 8.60, NULL),
(7, 1, 1, '2026-03-09 11:09:48', 'Cancelado', 'Llevar', 7.50, NULL),
(8, 1, 2, '2026-03-09 11:10:21', 'Entregado', 'Local', 7.50, NULL),
(9, 1, 3, '2026-03-09 11:14:04', 'Entregado', 'Llevar', 7.50, NULL),
(10, 1, 4, '2026-03-09 11:15:31', 'Cancelado', 'Local', 7.50, NULL),
(11, 1, 5, '2026-03-09 12:35:15', 'Cancelado', 'Llevar', 15.50, NULL),
(12, 1, 6, '2026-03-09 12:55:55', 'Cancelado', 'Llevar', 15.50, NULL),
(13, 5, 1, '2026-03-10 23:16:17', 'Entregado', 'Local', 22.51, 1),
(14, 1, 1, '2026-04-08 12:10:23', 'Entregado', 'Local', 13.20, 1),
(15, 1, 2, '2026-04-08 12:17:25', 'Entregado', 'Local', 6.60, 1),
(16, 1, 3, '2026-04-08 12:17:47', 'Entregado', 'Local', 6.60, 1),
(17, 1, 4, '2026-04-08 12:27:05', 'Entregado', 'Llevar', 49.96, 1),
(18, 1, 5, '2026-04-08 12:57:16', 'Entregado', 'Local', 6.60, 1);
...
INSERT INTO `pedidos_productos` (`id_pedido`, `id_producto`, `cantidad`, `precio_unitario`, `iva`, `estado`) VALUES
(1, 2, 2, 6.20, 21, 'En preparacion'),
(2, 2, 1, 6.20, 21, 'En preparacion'),
(3, 2, 2, 6.20, 21, 'En preparacion'),
(4, 2, 1, 6.20, 21, 'En preparacion'),
(5, 2, 1, 6.20, 21, 'En preparacion'),
(6, 2, 1, 6.20, 21, 'En preparacion'),
(7, 2, 1, 6.20, 21, 'En preparacion'),
(8, 2, 1, 6.20, 21, 'En preparacion'),
(9, 2, 1, 6.20, 21, 'En preparacion'),
(10, 2, 1, 6.20, 21, 'En preparacion'),
(11, 2, 1, 6.20, 21, 'En preparacion'),
(11, 5, 1, 6.61, 21, 'En preparacion'),
(12, 2, 1, 6.20, 21, 'En preparacion'),
(12, 5, 1, 6.61, 21, 'En preparacion'),
(13, 2, 3, 6.20, 21, 'Listo cocina'),
(14, 13, 2, 3.00, 10, 'Listo cocina'),
(14, 14, 1, 2.00, 10, 'Listo cocina'),
(14, 15, 1, 2.00, 10, 'Cocinando'),
(14, 16, 1, 2.00, 10, 'Cocinando'),
(15, 14, 1, 2.00, 10, 'Cocinando'),
(15, 15, 1, 2.00, 10, 'Cocinando'),
(15, 16, 1, 2.00, 10, 'Cocinando'),
(16, 14, 2, 2.00, 10, 'Cocinando'),
(16, 16, 1, 2.00, 10, 'Cocinando'),
(17, 2, 1, 6.20, 21, 'Listo cocina'),
(17, 16, 1, 2.00, 10, 'Listo cocina'),
(17, 20, 1, 4.20, 10, 'Listo cocina'),
(17, 22, 1, 15.50, 10, 'Listo cocina'),
(17, 23, 1, 16.90, 10, 'Listo cocina'),
(18, 14, 2, 2.00, 10, 'Listo cocina'),
(18, 16, 1, 2.00, 10, 'Listo cocina');
...
ALTER TABLE `pedidos`
  ...
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`id_cocinero`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL;
